...
class HomeScreen extends React.Component {
  ...
  _manageDisplay()
  {
    ...
    if (this.state.detail) {
      ...
      return (
      //on ne peut pas passer le state d'un component a un autre. Ensuite, et si jamais c'était possible, ce ne serait pas propre.
      // utiliser le state global via redux
        // <Result id ={this.state.id} target ={this.state.target}/>
        <Text>random modifié</Text>
      )
